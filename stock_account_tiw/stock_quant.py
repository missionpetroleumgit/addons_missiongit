...
class stock_quant(osv.osv):
    ...
    def _prepare_account_move_line(self, cr, uid, move, qty, cost, credit_account_id, debit_account_id, context=None):
        """
        Generate the account.move.line values to post to track the stock valuat ion difference due to the
        processing of the given quant.
        Aqui cambie el nombre de las lineas por el nombre del P.O.S (Ramses)
        -Campos agregados user.
        """
        if context is None:
            context = {}
