...
{
    'name' : 'Reportes para Petroleras',
    'version' : '1.1',
    'author' : 'Open Source Solutions',
    'category': 'Hidden',
    'description' : """

    Se agregaran los campos identificadores para las cuentas que se usan en los reportes de houston

""",
    'website': 'http://bitconsultores-ec.com',
    'images': [],
    'depends': [
        'account', 'o2s_sale_contract',
    ],
    'data': [
        'reports/report_definition.xml',
        'reports/report_invoice_disaggregated.xml',
