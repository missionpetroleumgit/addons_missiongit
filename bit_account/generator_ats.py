...
def crearXML(doc='Unknow', url='/data/110G/odooec/temp/'):    # Me crea el fichero con la fecha del período
...
# #CSV Detalle retenciones
                if ((t_comprobante != '04') and (t_comprobante != '15')) :
                    ...
                    for detalle_retencion in detalle_retenciones:
                        ...
                        elif codigo_ret in ('721', '723', '725', '727', '729'):
                            continue
...
def grabarXML(brw_codes, header, head_static, is_ats, doc='Unknow', url='/data/110G/odooec/temp/'): # Guardar la información en el fichero
    archi=open(str(url) + str(doc) + '.xml','w')
  # Escribo en el XML
...
def grabarXMLATS(self, cr, uid, brw_codes, header, head_static, is_ats, doc='Unknow', url='/data/110G/odooec/temp/'): # Guardar la información en el fichero
    archi=open(str(url) + str(doc) + '.xml','w')
  # Escribo en el XML
    #archi.write('<?xml version="1.0" encoding="UTF-8" standalone="yes"?>\n')
