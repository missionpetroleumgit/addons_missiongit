...
class report_104(osv.Model):
    _name = "report.104"
    _description = 'Reporte Formulario 104'
    ...
    def get_lines_report_wage(self, cr, uid, form):
        ...
        data = {}
        if period:
            imp_id = impuestos.search(cr, uid, [('form', '=', '104')], order='code')
            ...
            for code_imp in imp_data:
                ...
                ret = 0.00
                data = {}
                inv_ids = facturas.search(cr, uid, [('period_id', '=', period[0]),('state', 'in', ['paid','open']),('type', 'in', ['in_invoice','out_invoice'])], order='id')
                ...
                if len(imp_fact)>0:
                    ...
                    for fact_imp in imp_fact_data:
                        ...
                        if fact_imp.deduction_id:
                            ...
                            num_ret = ''
                        print "retencion: ",  fact_imp.deduction_id.id
                        print "factura: ",  fact_imp.invoice_id.id
                        data['sec'] = sec
