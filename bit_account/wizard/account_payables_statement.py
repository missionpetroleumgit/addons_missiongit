...
class account_payables_statement(models.TransientModel):
    _name = "account.payables.statement"
    ...
    def default_get(self, fields_list):
        res = super(account_payables_statement, self).default_get(fields_list)
    ...
    def generar(self):
        ...
        try:
            ...
            data_fname = "Estado de cuenta proveedores.xls"

            archivo = '/opt/temp/' + data_fname
            res_model = 'account.payables.statement'
