...
class report_purchase_order_wrapped(report_sxw.rml_parse):
    _name = 'report.print.egreso.cheque.wrapped'

    def __init__(self, cr, uid, name, context):
        super(report_purchase_order_wrapped, self).__init__(cr, uid, name, context)
        self.number_lines = 0
        self.number_add = 0
...
class report_purchase_order(osv.AbstractModel):
    _name = 'report.bit_product_tiw.report_purchase_order'
    _inherit = 'report.abstract_report'
    _template = 'bit_product_tiw.report_purchase_order'
    _wrapped_report_class = report_purchase_order_wrapped
