...
##############################################################################
{
    ...
    "data": [
        ...
        # 'views/wizard_generate_partial_importation.xml',
        'views/wizard_generate_invoice.xml',
        # 'views/wizard_generate_partial_invoice.xml',
        'views/wizard_invoice_group.xml',
        # 'views/wizard_costs_invoice_group.xml',
        'views/purchase.xml',
