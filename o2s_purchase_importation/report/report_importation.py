...
class report_purchase_importation_wrapped(report_sxw.rml_parse):
    _name = 'report.purchase.importation.wrapped'

    def __init__(self, cr, uid, name, context):
        super(report_purchase_importation_wrapped, self).__init__(cr, uid, name, context)
        self.number_lines = 0
        self.number_add = 0
...
class report_importation(osv.AbstractModel):
    _name = 'report.o2s_purchase_importation.report_importation'
    _inherit = 'report.abstract_report'
    _template = 'o2s_purchase_importation.report_importation'
    _wrapped_report_class = report_purchase_importation_wrapped
