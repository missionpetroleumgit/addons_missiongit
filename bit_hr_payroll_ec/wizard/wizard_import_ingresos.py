...
class wizard_import_ingresos(osv.osv_memory):
    _name = 'wizard.import.ingresos'
...
#         print "FORM TEXT", form
        ...
        for item in buf:
            ...
            if company_id:
                emp_id = self.pool.get('hr.employee').search(cr, uid, [('identification_id', '=', cedul), ('company_id', '=', company_id[0])])
            else:
