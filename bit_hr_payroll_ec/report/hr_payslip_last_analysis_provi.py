...
class hr_payslip_last_analysis_categ2(osv.Model):
    _name = "hr.payslip.last.analysis.categ2"
    ...
    def init(self, cr):
        tools.drop_view_if_exists(cr, 'hr_payslip_last_analysis_categ2')
        cr.execute("""
            create or replace view hr_payslip_last_analysis_categ2 as (
                select 
                    min(pl.id) as id, 
